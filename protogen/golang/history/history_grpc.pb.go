...
type QuizCompletionHistoryServiceClient interface {
	...
	GetAll(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[QuizCompletionHistoryItem], error)
...
func (c *quizCompletionHistoryServiceClient) GetAll(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[QuizCompletionHistoryItem], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[Empty, QuizCompletionHistoryItem]{ClientStream: stream}
...
type QuizCompletionHistoryServiceServer interface {
	...
	GetAll(*Empty, grpc.ServerStreamingServer[QuizCompletionHistoryItem]) error
...
func (UnimplementedQuizCompletionHistoryServiceServer) GetAll(*Empty, grpc.ServerStreamingServer[QuizCompletionHistoryItem]) error {
...
func _QuizCompletionHistoryService_GetAll_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(QuizCompletionHistoryServiceServer).GetAll(m, &grpc.GenericServerStream[Empty, QuizCompletionHistoryItem]{ServerStream: stream})
}
...
var QuizCompletionHistoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "cmd/history/api/history.proto",
}
