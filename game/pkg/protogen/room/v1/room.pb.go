...
const file_room_proto_rawDesc = "" +
	...
	"\bJoinRoom\x12\x18.room.v1.JoinRoomRequest\x1a\x19.room.v1.JoinRoomResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/api/v1/rooms/{code}/joinB)Z'gordle/game/pkg/protogen/room/v1;roomv1b\x06proto3"
