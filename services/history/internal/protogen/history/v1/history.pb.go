...
const file_history_proto_rawDesc = "" +
	...
	"\x0e\n" +
	"\n" +
	"BearerAuth\x12\x00\x82\xd3\xe4\x93\x02\x11\x12\x0f/api/v1/historyBQZOgithub.com/mibrgmv/whoami-server/history/internal/protogen/history/v1;historyv1b\x06proto3"
