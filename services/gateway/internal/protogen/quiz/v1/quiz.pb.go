...
const file_quiz_proto_rawDesc = "" +
	...
	"\x0e\n" +
	"\n" +
	"BearerAuth\x12\x00\x82\xd3\xe4\x93\x02\x11\x12\x0f/api/v1/quizzesBKZIgithub.com/mibrgmv/whoami-server/gateway/internal/protogen/quiz/v1;quizv1b\x06proto3"
